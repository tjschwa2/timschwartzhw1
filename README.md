...
```bash
cookiecutter gh:tjschwa2/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named TimSchwartzHW1, then do;

```bash
git remote add origin git@github.com:tjschwa2/TimSchwartzHW1.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── TimSchwartzHW1	<- Your notebooks and scripts will live in the main project folder
